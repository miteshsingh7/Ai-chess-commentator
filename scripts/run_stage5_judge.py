...
def run_stage5_judge(
    predictions_path: str = ".stage5_output/stage5_predictions.json",
    output_scores_path: str = "data/stage5_judge_scores.json",
    final_report_path: str = "data/stage5_final_evaluation_report.json",
    summary_path: str = ".stage5_output/stage5_summary.json",
) -> Dict[str, Any]:
